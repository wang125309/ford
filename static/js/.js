...
!function t(e,o,n){function r(u,a){if(!o[u]){if(!e[u]){var c="function"==typeof require&&require;if(!a&&c)return c(u,!0);if(i)return i(u,!0);throw new Error("Cannot find module '"+u+"'")}var w=o[u]={exports:{}};e[u][0].call(w.exports,function(t){var o=e[u][1][t];return r(o?o:t)},w,w.exports,t,e,o,n)}return o[u].exports}for(var i="function"==typeof require&&require,u=0;u<n.length;u++)r(n[u]);return r}({1:[function(){$(function(){$.post("/nabob/wxconfig/",{url:location.href},function(t){wx.config(t),wx.ready(function(){wx.hideOptionMenu(),wx.onMenuShareTimeline({link:"http://www.360youtu.com/ford/template/index.html",imgUrl:"http://www.360youtu.com/ford/static/image/share-background.jpg",title:"锐界人生 不止于超越"}),wx.onMenuShareAppMessage({link:"http://www.360youtu.com/ford/template/index.html",imgUrl:"http://www.360youtu.com/ford/static/image/share-background.jpg",title:"锐界人生 不止于超越"})}),wx.error(function(){$.get("/nabob/update_access_token/",function(){$.post("/wxconfig/",{url:location.href},function(t){wx.config(t),wx.ready(function(){wx.onMenuShareTimeline({link:"http://www.360youtu.com/ford/template/index.html",imgUrl:"http://www.360youtu.com/ford/static/image/share-background.jpg",title:"锐界人生 不止于超越"}),wx.onMenuShareAppMessage({link:"http://www.360youtu.com/ford/template/index.html",imgUrl:"http://www.360youtu.com/ford/static/image/share-background.jpg",title:"锐界人生 不止于超越"})})})})})})})},{}]},{},[1]);
},{}]},{},[4])) ? [] :
      slice.call(
        isSimple && !maybeID ?
          maybeClass ? element.getElementsByClassName(nameOnly) : // If it's simple, it could be a class
